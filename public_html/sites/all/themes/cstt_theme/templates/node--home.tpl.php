...
<br>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4">
      <div class="thumbnail">
        <center>
            <div class="caption">
              <h3><a href="http://csteachingtips.org/browse-all?field_category_tid%5B%5D=4&keys=">Managing & Assessing</a></h3>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4">
      <div class="thumbnail">
        <center>
          <div class="caption">
            <h3><a href="http://csteachingtips.org/browse-all?field_category_tid%5B%5D=2&keys=">Organizing Curriculum</a></h3>
